...
(lines
    data-x (csv "testdata/city_temperatures.csv" month)
    data-y (csv "testdata/city_temperatures.csv" temp_beijing)
    color #aa4643
    marker-size 4pt)

(lines
    data-x (csv "testdata/city_temperatures.csv" month)
    data-y (csv "testdata/city_temperatures.csv" temp_moscow)
    color #89a54e
    marker-size 4pt)

(lines
    data-x (csv "testdata/city_temperatures.csv" month)
    data-y (csv "testdata/city_temperatures.csv" temp_telaviv)
    color #4572a7
    marker-size 4pt)

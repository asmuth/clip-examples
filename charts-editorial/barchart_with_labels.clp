...
(figure/plot
    ...
    bars (
        data-x (csv "testdata/city_temperatures_london.csv" month)
        data-y (csv "testdata/city_temperatures_london.csv" temperature)
        labels (csv "testdata/city_temperatures_london.csv" temperature_str)
        width (2em)
        color 2)
    legend (
        position (top left)
